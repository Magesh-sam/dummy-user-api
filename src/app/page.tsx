...
export default function Home() {
  ...
  return (
    <main className="min-h-screen mb-5 flex flex-col pt-[10%] items-center gap-5">
      ...
      <Link className=" text-sm sm:text-lg  md:text-xl lg:text-2xl" href='https://github.com/Magesh-sam/dummy-user-api'> <span className="w-max font-bold bg-clip-text  text-transparent bg-gradient-to-r  from-pink-500 to-purple-600 ">Source:</span> https://github.com/Magesh-sam/dummy-user-api</Link>
      </section>
